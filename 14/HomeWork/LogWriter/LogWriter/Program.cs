...
namespace LogWriter
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ConsoleLogWriter consoleLogWriter = ConsoleLogWriter.GetInstanseConsoleLogWriter(writer);
            FileLogWriter fileLogWriter = FileLogWriter.GetInstanceFileLogWriter(writerFile);
            ...
            MultipleLogWriter multipleLogWriter = MultipleLogWriter.GetInstanseMultipleLogWriter(consoleLogWriter, fileLogWriter);
