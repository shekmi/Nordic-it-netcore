        ...
        public ReminderItem Get(Guid id)
        {
            ...
            if (httpResponceMessage.StatusCode != HttpStatusCode.OK)
            {
                throw new Exception(
                    ...
                    $"Content: {httpResponceMessage.Content.ReadAsStringAsync().Result}"); //вывод текста ответа с сервера
            }

            var content = httpResponceMessage.Content.ReadAsStringAsync().Result;
